  ...
  class WEN_Associate_Social_Widget extends WP_Widget {
    ...
    function update( $new_instance, $old_instance ) {
      ...
      function form( $instance ) {
        ...
        <p>
          <label for="<?php echo $this->get_field_id( 'icon_size' ); ?>"><?php _e( 'Social Icon Size:', 'wen-associate' ); ?></label>
          <select id="<?php echo $this->get_field_id( 'icon_size' ); ?>" name="<?php echo $this->get_field_name( 'icon_size' ); ?>">
            <option value="small" <?php selected( $icon_size, 'small' ) ?>><?php _e( 'Small', 'wen-associate' ) ?></option>
            <option value="medium" <?php selected( $icon_size, 'medium' ) ?>><?php _e( 'Medium', 'wen-associate' ) ?></option>
            <option value="large" <?php selected( $icon_size, 'large' ) ?>><?php _e( 'Large', 'wen-associate' ) ?></option>
          </select>
        </p>
        <p>
            ...
            <div class="service-block-inner">
              ...
              <div class="service-block-inner-content">
                ...
                <?php if ( true != $args['disable_more_text'] ): ?>
                  <a href="<?php echo esc_url( $service['url'] ); ?>" class="read-more" title="<?php echo esc_attr( $service['title'] )?>" ><?php echo esc_html( $args['more_text'] ); ?></a>
                <?php endif ?>
